...
//Clase del arbol binario busqueda
...
public ArbolBinarioBusqueda(String logFilePath) {
        raiz = null;
        try {
            logWritter = new PrintWriter(new FileWriter("arbol_log.txt", true));
        } catch (IOException e) {
            e.printStackTrace();
        }
}
...
public void insertar (int valor) {
    ...
    logWritter.println("Insertado: " + valor);
}
